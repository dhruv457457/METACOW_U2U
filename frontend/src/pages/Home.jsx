...
const setMouseCoordsFromSection = (e) => {
  ...
  return (
    <div className="min-h-screen">
      {/* Hero Section */}
     <section
  onMouseMove={(e) => setMouseCoordsFromSection(e)} // 🔥 move handler here
  className="relative overflow-hidden bg-gradient-to-br from-purple-100 via-blue-100 to-white text-gray-900"
>
    ...
    <div className="text-center">
      ...
      <footer className="bg-gradient-to-t from-white via-blue-50 to-purple-50 text-gray-700 py-12 border-t border-purple-100 shadow-inner">
        <div className="max-w-7xl mx-auto px-4 text-center">
          ...
          <p className="text-gray-500 mb-3">Built with ❤️ for the DeFi community</p>
